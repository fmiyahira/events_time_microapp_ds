      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            const SizedBox(height: kComponentSpacerXL),
            DSText('Just a text', type: DSTextType.BODY),
            DSText('Just a text', type: DSTextType.BODY_CAPTION),
            DSText('Just a text', type: DSTextType.BODY_SMALL),
            DSText('Just a text', type: DSTextType.BODY_SMALLER),
            DSText('Just a text', type: DSTextType.HEADING1),
            DSText('Just a text', type: DSTextType.HEADING2),
            DSText('Just a text', type: DSTextType.HEADING3),
            DSText('Just a text', type: DSTextType.HEADING4),
            DSText('Just a text', type: DSTextType.HERO),
            DSText('Just a text', type: DSTextType.INPUT),
            DSText('Just a text', type: DSTextType.LABEL),
            DSText('Just a text', type: DSTextType.LABEL_SMALL),
            DSText('Just a text', type: DSTextType.NUMBER),
            DSText('Just a text', type: DSTextType.NUMBER_SMALL),
            dividerWithPadding(),
            DSText(
              'Just a text',
